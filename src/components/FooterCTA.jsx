...
const FooterCTA = () => {
  ...
  return (
    <div className="relative w-full flex rounded-md items-center -translate-y-1/2 px-11 max-w-[1110px] min-h-[135px] py-10 lg:py-1 border-2 border-gray lg:rounded-full bg-dark-green ">
